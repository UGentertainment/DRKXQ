(function() {
    ...
    var root = window;
    var INDEX_KEY = 'drkxq:rmmv:v1:index';
    var DATA_PREFIX = 'drkxq:rmmv:v1:data:';
    var LOCAL_KEY = 'drkxq:rmmv:local-preview:v1';
    ...
    root.XRKXQSaveAdapter = {
        initialize: async function() {
            ...
            await preload();
            installStorage();
            // Save migrations are game-specific. Winter Memories starts with
            // a fresh namespace and deliberately does not inherit Summer's.
            installSaveAction();
            installReadyHook();
            return true;
        },
